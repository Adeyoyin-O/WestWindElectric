      ...
      <section className="bg-gradient-to-r from-slate-50 to-blue-50 py-16 border-b border-slate-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            <div className="text-center group p-4 rounded-lg bg-white/50 shadow-lg transition-all duration-300 hover:bg-white hover:shadow-xl hover:-translate-y-1">
              ...
              <h3 className="text-base font-bold text-slate-900 mb-1 group-hover:text-blue-700 transition-colors duration-300">13+ Years of Proven Delivery</h3>
              <p className="text-xs text-slate-700 group-hover:text-slate-800 transition-colors duration-300">Trusted expertise in<br />complex engineering projects</p>
            </div>
            ...
            <div className="text-center group p-4 rounded-lg bg-white/50 shadow-lg transition-all duration-300 hover:bg-white hover:shadow-xl hover:-translate-y-1">
              ...
              <p className="text-xs text-slate-700 group-hover:text-slate-800 transition-colors duration-300">Complete engineering, procurement, installation & commissioning</p>
            </div>
            ...
            <div className="text-center group p-4 rounded-lg bg-white/50 shadow-lg transition-all duration-300 hover:bg-white hover:shadow-xl hover:-translate-y-1">
              ...
              <h3 className="text-base font-bold text-slate-900 mb-1 group-hover:text-blue-700 transition-colors duration-300">Powering Land & Sea</h3>
              <p className="text-xs text-slate-700 group-hover:text-slate-800 transition-colors duration-300">Specialized solutions for<br />power and maritime industries</p>
            </div>
            ...
            <div className="text-center group p-4 rounded-lg bg-white/50 shadow-lg transition-all duration-300 hover:bg-white hover:shadow-xl hover:-translate-y-1">
              ...
              <h3 className="text-base font-bold text-slate-900 mb-1 group-hover:text-blue-700 transition-colors duration-300">Smart Systems Integration</h3>
              <p className="text-xs text-slate-700 group-hover:text-slate-800 transition-colors duration-300">Advanced automation and<br />control system solutions</p>
            </div>
          </div>
        </div>
      </section>
